...
public class UserdataRepositorySpringJdbc implements UserdataUserRepository {
    ...
    JdbcTemplate jdbcTemplate = new JdbcTemplate(DataSources.getDataSource(CFG.userdataJdbcUrl()));
    ...
    public Optional<UserEntity> findById(UUID id) {
        ...
        return Optional.ofNullable(
                jdbcTemplate.queryForObject(sql, UserdataUserEntityRowMapper.instance, id)
        );
    }
    ...
    public Optional<UserEntity> findByUsername(String userName) {
        ...
        return Optional.ofNullable(
                jdbcTemplate.queryForObject(sql, UserdataUserEntityRowMapper.instance, userName)
        );
    }
