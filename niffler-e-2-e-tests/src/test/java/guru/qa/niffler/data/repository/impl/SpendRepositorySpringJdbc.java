...
public class SpendRepositorySpringJdbc implements SpendRepository {
    ...
    private final JdbcTemplate jdbcTemplate = new JdbcTemplate(DataSources.getDataSource(CFG.spendJdbcUrl()));
    ...
    public SpendEntity update(SpendEntity spend) {
        String updateSql = "UPDATE spend " +
                "SET spend_date = ?, currency = ?, amount = ?, description = ? " +
                "WHERE id = ?";
